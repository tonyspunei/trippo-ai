export const getGenerateUserMessage = (
  ...
  return `
  I will give you some details about the user's background, and you are to give 
  THREE potential travel destination spots. For each spot, you'll give me a few 
  pieces of info: The City name, The country, and a 1-sentence description of the 
  city, and 3 key characteristics (reasons) of the city that may make it appealing 
  for the user.
  ...
  Give your answer in JSON format. Your response should look exactly like this:
...
export const getSaveDestinationUserMessage= ({
  ...
  - Flight prices ranges (in economy) that they can expect. I know this depends on the season, but try to give your best general estimate.
