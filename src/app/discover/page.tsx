        ...
        <form action={formAction}>
          <div className="grid grid-cols-3 gap-8">
            <div className="flex flex-col w-fit space-y-2">
              ...
              <input id="days" name="days" type="number" placeholder="Between 3 and 10" className="ring-1 ring-inset ring-gray-300 block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm" />
            </div>
            <div className="flex flex-col w-fit space-y-2">
              <label className="block text-sm font-medium leading-6 text-gray-900" htmlFor="budget">What is your max budget (in €)?</label>
              <input id="budget" name="budget" type="number" placeholder="€5000" className="ring-1 ring-inset ring-gray-300 block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm" />
            </div>
            <div className="flex flex-col w-fit space-y-2">
              <label className="block text-sm font-medium leading-6 text-gray-900" htmlFor="from">Where are you travelling from?</label>
              <input id="from" name="from" type="text" placeholder="E.g. London" className="ring-1 ring-inset ring-gray-300 block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm" />
            </div>
          </div>
          <div className="flex flex-col space-y-2 max-w-lg mt-8">
            ...
            <textarea id="details" name="details" rows={4} placeholder="I want to go on an adventure trip. I like mountains, hiking and nature." className="block mt-2 w-full ring-1 ring-inset ring-gray-300 rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm">
            </textarea>
          </div>
